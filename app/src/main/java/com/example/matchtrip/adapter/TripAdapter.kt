...
class TripAdapter : RecyclerView.Adapter<TripAdapter.TripViewHolder>() {
    ...
    class TripViewHolder(val tripBinding: TripLayoutBinding) :
        RecyclerView.ViewHolder(tripBinding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TripViewHolder {
        val tripBinding =
            TripLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: TripViewHolder, position: Int) {
        ...
        holder.tripBinding.root.setOnClickListener {
            val intent =
                Intent(holder.tripBinding.root.context, TripDescriptionActivity::class.java)
