...
class DescriptionTripAdapter :
    RecyclerView.Adapter<DescriptionTripAdapter.DescriptionViewHolder>() {
    ...
    class DescriptionViewHolder(
        ...
        var ivIzquerda: ImageView,
        var ivDerecha: ImageView
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DescriptionViewHolder {
        binding =
            PhotoDescriptionBinding.inflate(LayoutInflater.from(parent.context), parent, false)
